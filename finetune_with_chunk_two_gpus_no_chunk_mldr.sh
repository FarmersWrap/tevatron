...
deepspeed --include localhost:0,1 --master_port 60000 --module tevatron.retriever.driver.train \
  --deepspeed deepspeed/ds_zero3_aggressive.json \
...
#   --output_dir=temp \
#   --model_name_or_path Qwen/Qwen3-Embedding-0.6B \
#   --lora_name_or_path /root/autodl-tmp/tevatron/retriever-two-gpu-no-chunk-mldr \
#   --bf16 \
...
#   --query_max_len 32 \
#   --dataset_name json \
#   --dataset_path /root/autodl-tmp/tevatron/data/queries.jsonl \
#   --dataset_split train \
...
#   --passage_max_len 4096 \
#   --dataset_name json \
#   --dataset_path /root/autodl-tmp/tevatron/data/corpus.jsonl \
#   --dataset_split train \
...
#                                                        --output ${output_dir}/rank.mldr.trec \
#                                                        --remove_query
# python -m pyserini.eval.trec_eval -c -mrecall.100 -mndcg_cut.10 /root/autodl-tmp/tevatron/data/qrels.txt ${output_dir}/rank.mldr.trec
