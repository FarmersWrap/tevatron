rm -rf retriever-one-gpu-no-chunk
...
output_dir=/root/autodl-tmp/tevatron/retriever-one-gpu-no-chunk
CUDA_VISIBLE_DEVICES=0 python -m tevatron.retriever.driver.encode  \
  --output_dir=temp \
  --model_name_or_path Qwen/Qwen3-Embedding-0.6B \
  --lora_name_or_path /root/autodl-tmp/tevatron/retriever-one-gpu-no-chunk\
  --bf16 \
